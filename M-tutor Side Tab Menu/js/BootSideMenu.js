...
(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options ) {
		...
		newCode += "	<div class=\"col-xs-12 col-sm-12 col-md-12 col-lg1-12 mCustomScrollbar\" data-side=\""+side+"\">\n"+ oldCode+" </div>\n";
		newCode += "</div>";
		newCode += "<div class=\"toggler\">\n";
		newCode += "	<span class=\"fa fa-chevron-right fa-lg\">&nbsp;</span> <span class=\"fa fa-chevron-left fa-lg\">&nbsp;</span>\n";
		newCode += "</div>\n";
