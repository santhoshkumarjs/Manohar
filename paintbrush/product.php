...
<?php } ?>	
	...
	<div class="col-xs-12 col-md-6 col-sm-10" id="tab1">
		<div class="orbit-container">			
				<img id="myImg" src="resources/uploads/products/large/<?php echo $data['image']; ?>" alt="" itemprop="image" class="img-responsive" id="switcher"/>							
				...
				<div class="para_heading">
					...
					<div class="col-sm-6 ">
						<form id='myform' method='POST' action='#'>
							...
							<input type='text' name='quantity1' value='1' class='qty' readonly/>
						...
						<?php 
							//if(!empty($printpaper)) { ?>
								...
								<li class="col-md-12 col-sm-6  col-xs-12">							
										<label>
											<input checked="checked" name="ppaper" type="radio">
											<span class="lbl padding-8"><?php echo $data['size']; ?></span>
										</label>
									</li>
								<?php foreach($printpaper as $ps){   ?>
									<li class="col-md-12 col-sm-6  col-xs-12">							
										<label>
											<input name="ppaper" type="radio">
						...
						<?php 
							//if(!empty($printcanvas)) { ?>
								<ul class="question-col billing_add" style="padding:0px">
									<li class="col-md-12 col-sm-6  col-xs-12">							
										<label>
											<input checked="checked" name="pcanvas" type="radio">
											<span class="lbl padding-8"><?php echo $data['size']; ?></span>
										</label>
									</li>								
...
<div class="thumbnails_caption">
	...
	<img class="img-responsive" src="resources/uploads/products/thumb/<?php echo $rprod['thumbImage']; ?>"  style="width:243px; height:163px"></a>
	<div class="thirdrow">
