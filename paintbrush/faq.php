					...
					<div class="col-md-4 content_left">
						<div class="tabs-left left_nav_tab Policy">
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#e" data-toggle="tab">FAQ</a></li>
						...
						<div class="tab-content tab_conent_pad">
							...
							<div class="tab-pane active" id="e">
								<div class="row mrg_0 Policy tab_row_bg">
									<h3 class="Policy_heading">Frequently Asked Questions</h3>
...
foreach($data as $faq){ ?>
	<div class="accordion-section">
		<a class="accordion-section-title" href="#accordion-<?php echo $i; ?>">Q: <?php echo $faq['question']; ?> 
		<!--<i class="glyphicon glyphicon-chevron-up glyphiconsize pull-right"></i>--></a>
