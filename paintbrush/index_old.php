<?php	require 'framework/initialise/framework.init.php'; 
        ...
        $feature_sql = "select * from product where featured = 'yes' and status = 'active' and quantity != 0 limit 6";
		$feature_data = $db['master']->getResults($feature_sql);
		
        $new_sql = "select * from product where status = 'active' and quantity != 0 and new_status = 1 order by id desc limit 6 ";
...
<div class="row">
<?php foreach($feature_data as $fdata){ ?>	
<div class="col-md-4 col-sm-6 ban banimag">
<a href="product.php?id=<?php echo $fdata['id']; ?>">
	<img src="resources/uploads/products/thumb/<?php echo $fdata['thumbImage']; ?>" alt="item" width="100%" height="300">
	<div class="ban_wrap">
...
<?php foreach($new_data as $ndata){ ?>
<div class="col-md-4 col-sm-6">
<div class="product-img">
	<a href="product.php?id=<?php echo $ndata['id']; ?>">
		<img src="resources/uploads/products/thumb/<?php echo $ndata['thumbImage']; ?>" width="100%" height="300" alt="item">
