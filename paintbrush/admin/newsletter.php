...
$select_query = "select * from newsletter where status = 'active' order by createdOn desc";
$count_query = "select count(*) as num from newsletter where status = 'active'";
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">				
				<div>
				  ...
				  <button class="btn btn-primary" type="submit" name="submit" id="delete" value="newsletter"> 
