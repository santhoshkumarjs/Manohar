 ...
 <head> 
  <title>mTutor</title>
	...
	<div class="container">
		...
		<?php } 
			  if($_SESSION['usertype'] != 'mtutor'){
		?>
			<div class="text-right">
				<button class="btn btn-success" data-toggle="modal" data-target="#myModal" data-target=".bs-example-modal-sm"> <i class="fa fa-plus"> </i> Add New University</button>
			</div>
		<?php } 
		?>
			<hr>			
						...
						<table id="reportdiv" class="table table-striped table-hover table-condensed">
							<thead>
								<tr>	
									<th>University</th>
									<th>Added On</th>								
								<?php if($_SESSION['usertype'] != 'mtutor'){ ?>
									<th>Action </th>	
								<?php } ?>
								</tr>
							</thead>
							<tbody>
							<?php
							    //$viewuniversity = viewUniversityList(); 
						
								if($viewuniversity[1]){
									foreach($viewuniversity[1] as $key){
										if($_SESSION['usertype']=='admin'){
											$deletebuttn = '<a style="margin-left: 50px;" href="" class="label label-danger" title="Detete" alt="Delete" data-toggle="modal" data-target=".bs-example-modal-sm2" onClick="deletedata('.$key['univid'].')"><i class="fa fa-trash"> </i></a>';
										}
										$listvalues .= '<tr>							
													   <td><a href="course.php?unid='.$key['univid'].'&name='.$key['university'].'">'.$key['university'].'</a> </td>
													   <td>'.$key['added_date'].'</td>';
										if($_SESSION['usertype'] != 'mtutor'){ 		   
											$listvalues .=  '<td class="td-action"><a href="" class="label label-warning" 		title="Edit" alt="Edit" data-toggle="modal" data-target=".bs-example-modal-sm4" onClick="editdata(\''.$key['univid'].'\',\''.$key['university'].'\',\''.$key['countryid'].'\')"><i class="fa fa-pencil"> </i></a>'.$deletebuttn.'  </td>';				
										}
										$listvalues .= '</tr>';
									}
								}
								...
								{
									$listvalues .= "<tr><td><b>No Records Found</b></td></tr>";
								}
								echo $listvalues;
							?>
							</tbody>
	...
	<!-- =====================================Popup part=====================================-->	
<!-- Modal -->
<form name="addpopup" id="addpopup" method="post" action="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="form-group">
			   <input type="hidden" name="editval" id="editval" value="">
				<label class="col-sm-4 control-label">Add New university</label>
				
				 <div class="col-sm-6 ">				
					<input type="text" placeholder="Add New university"  class="form-control" id="university" name="university">	
				</div>
      ...
      <div class="modal-footer" style="margin-top:15px;">
       <button class="btn btn-primary" type="submit" name="submitval" id="submitval"> <i class="fa fa-check"></i> Submit</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="form-group">
				<label class="col-sm-4 control-label">Edit University</label>
				 <div class="col-sm-6 ">				
