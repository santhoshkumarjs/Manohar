<?php	require 'framework/initialise/framework.init.php'; 
        ...
        $feature_sql = "select * from product where featured = 'yes' and status = 'active' and quantity != 0";
...
<a href="product.php?id=<?php echo $feature_data[$i]['id']; ?>">
<div class="image" style="background:url('resources/uploads/products/thumb/<?php echo $feature_data[$i]['thumbImage']; ?>');">	
	<div class="ban_wrap">
	  <h2><?php echo ucfirst($feature_data[$i]['artType']); ?></h2>
	  <h3><?php echo getStyleByID($feature_data[$i]['style']); ?></h3>
