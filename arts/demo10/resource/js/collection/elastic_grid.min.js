                    ...
                    if ("undefined" != typeof f.$largeImg && f.$largeImg.remove(), glarge = eldata.large, gthumbs = eldata.thumbnail, imgTitle = eldata.img_title, glarge.length == gthumbs.length && glarge.length > 0) {
                        ...
                        for (g = 0; g < gthumbs.length; g++) {
                            var i = $("<li></li>"),
                                ...
                                j = $("<img/>");
                            j.addClass("related_photo"), 0 == g && j.addClass("selected"), j.attr("src", gthumbs[g]), j.attr("data-large", glarge[g]), j.attr("alt", imgTitle[g]), j.attr("title", imgTitle[g]), e.append(j), i.append(e), h.append(i)
                        }
